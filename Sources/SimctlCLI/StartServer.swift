...
struct StartServer: ParsableCommand {
  ...
  mutating func run() throws {
    ...
    server.onInstallApp { deviceId, _, appBundlePath -> Result<String, Swift.Error> in
      runCommand(.simctlInstallApp(device: deviceId, appBundlePath: appBundlePath), verbose: v)
    }
